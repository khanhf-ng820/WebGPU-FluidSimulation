...
@group(0) @binding(3) var<storage> velFieldIn : array<f32>;
@group(0) @binding(4) var<storage> diffuseTempFieldIn : array<f32>;
@group(0) @binding(5) var<storage, read_write> tempFieldOut : array<f32>;
...
fn csMain(@builtin(global_invocation_id) cell : vec3<u32>) {
    ...
    tempFieldOut[idx] = (velFieldIn[idx] + a * (
